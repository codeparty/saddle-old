...
var Item, ItemRange, Saddle, doc, methodName, supportAttributes, _ref,
...
Saddle = (function() {
  ...
  getCachedItem = function(id, map) {
    var item;
    if ((item = map[id]) && doc.body.contains(item.el || item)) {
      return item;
    }
  };
  ...
  function Saddle(options) {
    ...
    this.useTags = options.useTags || !doc.createTreeWalker;
    this.itemsMap = {};
    this.markersMap = {};
    this._id = 0;
  }
  ...
  Saddle.prototype._updateMarkers = function() {
    var comment, commentIterator, comments, markersMap, _i, _len;
...
if (!supportAttributes) {
  Saddle.prototype.getAttr = Saddle.prototype.getProp;
  Saddle.prototype.setAttr = Saddle.prototype.setProp;
}
