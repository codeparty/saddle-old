...
Saddle = (function() {
  var createItemRange, getCachedItem, itemsMap, markersMap, prefix;
  ...
  createItemRange = function(id, comment) {
    return new ItemRange(comment, markersMap[prefix + id], id);
  };
  ...
  Saddle.prototype.get = function(id) {
    var comment, commentIterator, el, item;
    ...
    if (comment = getCachedItem(id, markersMap)) {
      return itemsMap[id] = createItemRange(id, comment, this.prefix);
    }
    markersMap = {};
