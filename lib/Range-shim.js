...
var RangeShim, WRAP_MAP, regex_leadingWhitespase, test_whitespaceKilled, util;
...
test_whitespaceKilled = (function() {
  var testDiv;
...
RangeShim = (function() {
  ...
  RangeShim.prototype.createContextualFragment = function(html) {
    var close, depth, el, fragment, open, parent, wrap;
    parent = this.startContainer;
    ...
    if (test_whitespaceKilled) {
      html.replace(regex_leadingWhitespase, function(whitespaces) {
        return fragment.insertBefore(whitespaces, fragment.firstChild);
      });
    }
    return fragment;
  };
